...
class ModchartState 
{
	...
	{
		#if sys
		var data:BitmapData = BitmapData.fromFile(lime.system.System.applicationStorageDirectory + "assets/data/" + PlayState.SONG.song.toLowerCase() + '/' + spritePath + ".png");

		var sprite:FlxSprite = new FlxSprite(0,0);

		sprite.frames = FlxAtlasFrames.fromSparrow(FlxGraphic.fromBitmapData(data), lime.system.System.applicationStorageDirectory + "assets/data/" + PlayState.SONG.song.toLowerCase() + "/" + spritePath + ".xml");
    ...
    function new()
    {
				...
				var result = LuaL.dostring(lua, Assets.getText(Paths.lua(PlayState.SONG.song.toLowerCase() + "/modchart"))); // execute le file
